...
export default function AdminDashboardPage() {
  ...
  const { records: recentImports, loading: importsLoading } = useImportHistory();
          ...
          <>
            {stats.missingStockPhotoCount > 0 && (
              <Alert variant="warning">
                <AlertTriangle />
                <AlertTitle>
                  {stats.missingStockPhotoCount} stock item(s) are missing a photo
                </AlertTitle>
                <AlertDescription>
                  <p>
                    These articles are in the latest stock upload but have no matching product
                    photo, so executives won&apos;t see them. Upload the missing photos or check{" "}
